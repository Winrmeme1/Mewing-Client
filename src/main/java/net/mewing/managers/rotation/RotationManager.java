...
package net.mewing.managers.rotation;
...
import net.mewing.managers.rotation.goals.Goal;
import net.mewing.mixin.interfaces.ILocalPlayer;
...
public class RotationManager implements TickListener, Render3DListener, SendPacketListener, SendMovementPacketListener {
	...
	private static final MewingClient MEWING = Mewing.getInstance();
	...
	public RotationManager() {
		MEWING.eventManager.AddListener(TickListener.class, this);
		MEWING.eventManager.AddListener(Render3DListener.class, this);
		MEWING.eventManager.AddListener(SendPacketListener.class, this);
		MEWING.eventManager.AddListener(SendMovementPacketListener.class, this);
	}
