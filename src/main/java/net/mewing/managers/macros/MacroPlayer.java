...
import net.mewing.mixin.interfaces.IKeyboardHandler;
import net.mewing.mixin.interfaces.IMouseHandler;
...
public class MacroPlayer {
	...
	public void play(Macro macro, Runnable onFinished) {
		...
		isPlaying = true;
		playbackThread = new Thread(this::execute, "mewing-macro-player");
