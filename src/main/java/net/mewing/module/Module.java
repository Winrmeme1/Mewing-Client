...
import net.mewing.interfaces.IMultiPlayerGameMode;
...
public abstract class Module {
	...
	protected final IMinecraft IMC = MewingClient.IMC;
	 ...
	 */
	public void toggle() {
		if (isDetectable(MEWING_CLIENT.moduleManager.antiCheat.getValue()))
	...
	public static boolean swap(int slot, boolean swapBack) {
		...
		((IMultiPlayerGameMode) MC.gameMode).mewing$syncSelected();
		return true;
	}
