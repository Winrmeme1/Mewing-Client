...
import net.mewing.event.events.ChunkEvent;
...
import net.mewing.event.listeners.ChunkListener;
...
public class BlockESP extends Module implements TickListener, Render3DListener, ChunkListener {
	...
	public void onDisable() {
		...
		Mewing.getInstance().eventManager.RemoveListener(ChunkListener.class, this);
	...
	public void onEnable() {
		...
		Mewing.getInstance().eventManager.AddListener(ChunkListener.class, this);
