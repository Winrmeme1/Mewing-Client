...
package net.mewing.gui.screens.addons;
...
public class AddonSelectionList extends ObjectSelectionList<AddonSelectionList.Entry> {
	...
	public static abstract class Entry extends ObjectSelectionList.Entry<net.mewing.gui.screens.addons.AddonSelectionList.Entry> implements AutoCloseable {
		@Override
		public void close() {
		}
	}

	public class NormalEntry extends net.mewing.gui.screens.addons.AddonSelectionList.Entry {
