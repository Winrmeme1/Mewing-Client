...
package net.mewing.gui.screens.alts;
...
import net.mewing.managers.altmanager.Alt;
...
public class AltSelectionList extends ObjectSelectionList<AltSelectionList.Entry> {
	...
	public void setSelected(@Nullable net.mewing.gui.screens.alts.AltSelectionList.Entry entry) {
	...
	public static abstract class Entry extends ObjectSelectionList.Entry<net.mewing.gui.screens.alts.AltSelectionList.Entry> implements AutoCloseable {
		@Override
		public void close() {
		}
	}

	public class NormalEntry extends net.mewing.gui.screens.alts.AltSelectionList.Entry {
		private final AltScreen owner;
