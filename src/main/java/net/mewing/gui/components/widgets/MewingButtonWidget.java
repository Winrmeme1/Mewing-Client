...
public class MewingButtonWidget extends AbstractButton {
	private Consumer<MewingButtonWidget> pressAction;
	private long hoverStartTime = 0;
	private static final long HOVER_ANIMATION_DURATION = 200000000;

	public MewingButtonWidget(int x, int y, int width, int height, Component message) {
		super(x, y, width, height, message);
	}

	public void setPressAction(Consumer<MewingButtonWidget> pressAction) {
