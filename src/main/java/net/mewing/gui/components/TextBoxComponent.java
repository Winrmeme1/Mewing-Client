...
import net.mewing.gui.TextWrapping;
		...
		if (listeningForKey) {
			...
			if (key == GLFW.GLFW_KEY_ENTER || key == GLFW.GLFW_KEY_ESCAPE) {
				...
				if (keyName != null && !keyName.isEmpty()) {
					...
					boolean shiftDown = GLFW.glfwGetKey(net.mewing.MewingClient.MC.getWindow().handle(), GLFW.GLFW_KEY_LEFT_SHIFT) == GLFW.GLFW_PRESS
							|| GLFW.glfwGetKey(net.mewing.MewingClient.MC.getWindow().handle(), GLFW.GLFW_KEY_RIGHT_SHIFT) == GLFW.GLFW_PRESS;
